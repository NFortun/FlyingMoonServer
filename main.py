...
from polar_align import polar_align_service, polar_align_pb2_grpc
import indi
import traceback
...
polar_align_pb2_grpc.add_PolarAlignServicer_to_server(polar_align_service.PolarAlignService(None, None, None), server)
